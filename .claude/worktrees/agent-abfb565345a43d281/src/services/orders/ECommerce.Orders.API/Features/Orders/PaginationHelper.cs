...
// Intentional local duplication of Catalog's PaginationHelper (CON-01 — Contracts stays free
// of utility/domain logic; no shared production utility library exists for this yet).
