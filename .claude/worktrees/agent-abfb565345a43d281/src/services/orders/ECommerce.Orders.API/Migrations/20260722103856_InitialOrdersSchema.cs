...
namespace ECommerce.Orders.API.Migrations
{
    ...
    public partial class InitialOrdersSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "OrderReadModels_LineItems",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderReadModels_LineItems", x => new { x.OrderReadModelId, x.Id });
                    table.ForeignKey(
                        name: "FK_OrderReadModels_LineItems_OrderReadModels_OrderReadModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderCorrelationId = table.Column<Guid>(type: "uuid", nullable: false),
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orders_LineItems", x => new { x.OrderCorrelationId, x.Id });
                    table.ForeignKey(
                        name: "FK_Orders_LineItems_Orders_OrderCorrelationId",
